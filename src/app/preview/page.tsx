        ...
        {loading && (
          <div className="flex items-center justify-center py-32">
            <div className="text-center max-w-md mx-auto">
              <div className="animate-spin rounded-full h-20 w-20 border-4 border-primary/20 border-t-primary mx-auto mb-8"></div>
              <h2 className="text-3xl font-serif font-bold text-foreground mb-4">Manifesting Masterpieces...</h2>
              <p className="text-lg text-muted-foreground">Your atelier awakens.</p>
            </div>
          </div>
        )}
